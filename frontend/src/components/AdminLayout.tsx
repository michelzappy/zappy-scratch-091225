...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-y-0 left-0 z-50 w-56 bg-white border-r border-gray-200 transform transition-transform duration-300 ease-in-out ${
        ...
        <div className="h-16 flex items-center px-6 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <span className="ml-3 text-lg font-semibold text-gray-900">Telehealth</span>
          </div>
        </div>
        ...
        <div className="border-t border-gray-200 p-4">
          <div className="flex items-center">
            ...
            <div className="ml-3 flex-1">
              ...
              <p className="text-xs text-gray-500">admin@telehealth.com</p>
            </div>
          </div>
          <button
            onClick={handleLogout}
            className="mt-3 w-full px-3 py-1.5 text-sm text-gray-600 hover:text-gray-900 hover:bg-gray-50 rounded-md transition-colors text-left"
          >
            Sign out
          </button>
        </div>
