-- REMOVED: This file has been archived to database/archived/unified-portal-schema.sql.bak
-- Reason: Conflicts with complete-schema.sql (references non-existent 'users' table)
-- Date: 2025-09-20
