-- Initial database setup for telehealth platform (Neon-compatible)
-- Creates basic schema without complex constraints
...
-- User sessions table (without complex check constraint)
